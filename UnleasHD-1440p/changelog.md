...
* adjusted PlayStation 5 buttons
* adjusted PlayStation 3 loading screen graphic
* adjusted loading screen town backgrounds
* added new stage screenshots
* added stage loading screen screenshots
* added he1compression
* added npc feeling icons
* readded hmm autoupdate
* fixed empire city font bug
* fixed DLC stage thumbnails
* improved loading screen town backgrounds
* improved Boost Gauge

## UnleasHD v1.4.0

* added 1440p version
* added new screenshots for all world map locations (day and night)
* added new screenshots to the event gallery
* added stage loading screen screenshots
* added act screenshots
* added staff roll and credits assets
* completed loading screen town backgrounds
* completed PlayStation 3 button assets
* completed PlayStation 5 button assets
* completed Nintendo GameCube button assets
* completed Nintendo Switch (Joy-Con) button assets
* completed Xbox Series X/S button assets
* fixed missing redrawn dialogue text
* improved Boost Gauge asset
* improved general text and dialogue assets
* improved Miles Electric loading screen assets
* improved mission-related assets
* improved results screen portraits
* improved results screen text elements
* improved Professor Pickle’s lab assets
* improved town UI assets
* improved settings descriptions to be clearer
